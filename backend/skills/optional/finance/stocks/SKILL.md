...
```
SCRIPT=~/.hollow/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.hollow/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
