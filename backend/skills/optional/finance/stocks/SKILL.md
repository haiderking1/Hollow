...
```
SCRIPT=~/.enough/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.enough/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
