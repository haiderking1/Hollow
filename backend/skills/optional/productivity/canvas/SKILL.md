...
4. Name the token (e.g., "Hollow"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${HOLLOW_HOME:-~/.hollow}/.env`:
...
```bash
CANVAS="python $HOLLOW_HOME/skills/productivity/canvas/scripts/canvas_api.py"
