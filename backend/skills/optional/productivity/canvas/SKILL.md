...
4. Name the token (e.g., "Enough"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${ENOUGH_HOME:-~/.enough}/.env`:
...
```bash
CANVAS="python $ENOUGH_HOME/skills/productivity/canvas/scripts/canvas_api.py"
