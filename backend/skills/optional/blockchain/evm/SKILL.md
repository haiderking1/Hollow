...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Enough
license: MIT
...
Helper script path: `~/.enough/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.enough/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.enough/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.enough/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
