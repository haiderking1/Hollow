...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Hollow
license: MIT
...
Helper script path: `~/.hollow/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.hollow/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.hollow/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.hollow/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
