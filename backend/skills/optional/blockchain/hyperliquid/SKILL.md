...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Hollow
license: MIT
...
The script reads `${HOLLOW_HOME:-~/.hollow}/.env` for two optional defaults:
...
Helper script: `~/.hollow/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.hollow/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HOLLOW_HOME:-~/.hollow}/.env`.
...
```bash
python3 ~/.hollow/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.hollow/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
