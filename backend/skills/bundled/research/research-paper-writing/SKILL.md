...
This skill is designed for the Hollow agent. It uses Hollow tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Hollow skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.hollow/plans/` | `skill_view("plan")` |
