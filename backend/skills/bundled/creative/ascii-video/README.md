...
Built for [Hollow](https://github.com/haiderking1/Hollow). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/Hollow skills tree (bundled/)creative/ascii-video`](https://github.com/haiderking1/Hollow/tree/main/skills/creative/ascii-video) via PR.
