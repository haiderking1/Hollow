...
Built for [Enough](https://github.com/enough/enough). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/Enough skills tree (bundled/)creative/ascii-video`](https://github.com/enough/enough/tree/main/skills/creative/ascii-video) via PR.
