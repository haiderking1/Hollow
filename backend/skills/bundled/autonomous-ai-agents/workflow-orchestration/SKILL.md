...
description: Write task-specific Enough JavaScript workflows with staged subagents, structured schemas, dynamic routing, and pre-filtered data.
---
...
1. Write JavaScript to `.enough/workflows/<id>/workflow.js`.
...
10. Do not execute the script while authoring it. The user reviews it, then Enough runs it.
